...
const memories = [
  {
    id: 1,
    rotation: "-3deg",
    caption: "food tastes better together ♡",
    position: "left-2 top-2",
  },
  {
    id: 2,
    rotation: "4deg",
    caption: "just us, taking a little break ☕",
    position: "right-2 top-[300px]",
  },
  {
    id: 3,
    rotation: "-2deg",
    caption: "a cozy little moment",
...
export default function CafeMemories() {
  ...
  useEffect(() => {
    const loadPhotos = async () => {
      ...
      if (error) {
        console.error("Failed to load Cafe memories:", error);
        return;
      }
  ...
  const handleUpload = async (event, id) => {
    ...
    try {
      ...
      const filePath = `cafe/photo-${id}-${Date.now()}.${fileExtension}`;
      ...
      <div className="mx-auto max-w-lg">
        ...
        >
          ...
          <p className="mt-3 text-sm text-gray-500">
            A little break in the middle of our adventure.
          </p>
        </motion.div>
